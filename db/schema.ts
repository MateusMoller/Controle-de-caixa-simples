...
export const entries = pgTable("entries", {
  ...
  interestType: text("interest_type", { enum: ["none", "simple", "compound"] })
    .notNull()
    .default("none"),
...
export const entryDescriptions = pgTable("entry_descriptions", {
  id: serial("id").primaryKey(),
  name: text("name").notNull().unique(),
});

export const entryContacts = pgTable("entry_contacts", {
  id: serial("id").primaryKey(),
  name: text("name").notNull().unique(),
});
